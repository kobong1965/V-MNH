...
## 2026-08-12：0.5.24 图片覆盖与画布文字标注

规格：`docs/FEATURE_IMAGE_REPLACE_ANNOTATION_V0524.md`

1. 扩展节点和分组数据，保存说明文字、字号和颜色。
2. 图片节点增加右上角覆盖上传，复用项目媒体存储并保持节点与连线不变。
3. 图片节点增加文字标注编辑；分组包围框增加工作流命名和样式编辑。
4. 完成类型、测试、生产构建、浏览器交互和桌面原位更新；本轮不上传 GitHub。
